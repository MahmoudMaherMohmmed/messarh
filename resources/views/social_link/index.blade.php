@extends('template')
@section('page_title')
    @lang('messages.social_links.social_links')
@stop
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-black">
                        <div class="box-title">
                            <h3><i class="fa fa-table"></i> @lang('messages.social_links.social_links')</h3>
                        </div>
                        <div class="box-content">
                            <div class="btn-toolbar pull-right">
                                <div class="btn-group">
                                    @if (get_action_icons('social_link/create', 'get'))
                                        <a class="btn btn-circle show-tooltip" title=""
                                            href="{{ url('social_link/create') }}" data-original-title="Add new record"><i
                                                class="fa fa-plus"></i></a>
                                    @endif
                                    <?php $table_name = 'social_links';
                                        ...
                                        @foreach ($social_links as $value)
                                            <tr>
                                                ...
                                                <td class="visible-md visible-xs visible-sm visible-lg">
                                                    <div class="btn-group">
                                                        @if (get_action_icons('social_link/{id}/edit', 'get'))

                                                            <a class="btn btn-sm show-tooltip"
                                                                href='{{ url("social_link/$value->id/edit") }}'
                                                                title="Edit"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                        @if (get_action_icons('social_link/{id}/delete', 'get'))
                                                            <form action="{{ route('social_link.destroy', $value->id) }}"
...
@section('script')
    <script>
        ...
        $('#social_link_index').addClass('active');
    </script>
@stop
