        ...
        <div class="container" id="main-container">
            ...
            <div id="sidebar" class="navbar-collapse collapse">
                ...
                <ul class="nav nav-list">
                    ...
                    <?php if(get_action_icons('specialty', 'get')): ?>
                    <ul class="nav nav-list">
                        <li id="specialty">
                            <a href="#" class="dropdown-toggle">
                                <i class="glyphicon glyphicon-user"></i>
                                <span><?php echo app('translator')->get('messages.specialties.specialties'); ?></span>
                                <b class="arrow fa fa-angle-right"></b>
                            </a>

                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="specialty_index"><a href="<?php echo e(url('specialty')); ?>"><?php echo app('translator')->get('messages.specialties.specialties'); ?></a></li>
                                <li id="specialty_create"><a href="<?php echo e(url('specialty/create')); ?>"><?php echo app('translator')->get('messages.specialties.create_specialty'); ?></a></li>
                            </ul>
                        </li>
                    </ul>
                    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\messarh\resources\views/template.blade.php ENDPATH**/ ?>