        ...
        <div class="tab-content">
            ...
            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="tab-pane fade in <?php echo e($i++ ? '' : 'active'); ?>" id="title<?php echo e($language->short_code); ?>">
                    <input class="form-control" name="title[<?php echo e($language->short_code); ?>]" value="<?php if($specialty): ?> <?php echo $specialty->getTranslation('title', $language->short_code); ?> <?php endif; ?>" />
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<div class="form-group">
    <label class="col-sm-3 col-lg-2 control-label"><?php echo app('translator')->get('messages.description'); ?> <span
            ...
            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="tab-pane fade in <?php echo e($i++ ? '' : 'active'); ?>"
                    ...
                    <textarea class="form-control col-md-12"
                        name="description[<?php echo e($language->short_code); ?>]" rows="6">
                        <?php if($specialty): ?> 
                            <?php echo e($specialty->getTranslation('description', $language->short_code)); ?>

                        <?php else: ?>
                            <?php echo e(old('description.' . $language->short_code)); ?>
    ...
    <div class="col-sm-9 col-md-8 controls">
        <div class="fileupload fileupload-new" data-provides="fileupload">
            <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                <?php if($specialty): ?>
                    <img src="<?php echo e($specialty->image); ?>" alt="" />
                <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\messarh\resources\views/specialty/input.blade.php ENDPATH**/ ?>