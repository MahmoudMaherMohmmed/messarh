        ...
        <div class="tab-content">
            ...
            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="tab-pane fade in <?php echo e($i++ ? '' : 'active'); ?>" id="title<?php echo e($language->short_code); ?>">
                    <input class="form-control" name="title[<?php echo e($language->short_code); ?>]" value="<?php if($provider): ?> <?php echo $provider->getTranslation('title', $language->short_code); ?> <?php endif; ?>" />
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\messarh\resources\views/provider/input.blade.php ENDPATH**/ ?>